...
public class CommandListTests extends AbstractCommand {
  ...
  public static final List<String> COMMANDS = List.of(
      ...
      "t_alias3 argName",
      "t_alias4 argName",
      "test_annotation block_test minecraft:stone_slab[waterlogged=true]",
      "test_annotation variables 4",
      "test_annotation integer_range 1..4",
      "test_annotation integer_range ..",
      ...
      "test_annotation double_suffix 2.43ten",
      "test_annotation double_suffix 2.43hundred",
      "test_annotation double_suffix 2.43hundred-1ten",
      "test_annotation double_suffix 2.43hundred+3.1ten",
      "test_alias_1",
      "test_alias_2",
